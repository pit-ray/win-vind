...
|`<Up>`, `-`, `<C-p>`, `k`, `gk`|[\<move_caret_up\>]({{ site.url }}/cheat_sheet/functions/#move_caret_up)|
|`gj`, `+`, `<C-m>`, `<Down>`, `<C-n>`, `j`, `<Enter>`|[\<move_caret_down\>]({{ site.url }}/cheat_sheet/functions/#move_caret_down)|
