...
|`:`|`<to_command>`|
|`<Esc-Down>`|`<to_resident>`|
|`I`, `<Esc-Right>`, `<ctrl-[>`|`<to_edi_normal>`|
|`i`|`<to_insert>`|
|`v`|`<to_gui_visual>`|
...
|`:source`|`<source>`|
|`:${MODE}map`|`<${MODE}map>`|
|`:${MODE}mapclear`|`<${MODE}mapclear>`|
|`:${MODE}noremap`|`<${MODE}noremap>`|
|`:${MODE}unmap`|`<${MODE}unmap>`|
