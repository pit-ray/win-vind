...
- [win-vind_5.2.1_32bit_installer.zip](https://github.com/pit-ray/win-vind/releases/download/v5.2.1/win-vind_5.2.1_32bit_installer.zip)
- [win-vind_5.2.1_64bit_installer.zip](https://github.com/pit-ray/win-vind/releases/download/v5.2.1/win-vind_5.2.1_64bit_installer.zip)

### Portable Zip
- [win-vind_5.2.1_32bit_portable.zip](https://github.com/pit-ray/win-vind/releases/download/v5.2.1/win-vind_5.2.1_32bit_portable.zip)
- [win-vind_5.2.1_64bit_portable.zip](https://github.com/pit-ray/win-vind/releases/download/v5.2.1/win-vind_5.2.1_64bit_portable.zip)
