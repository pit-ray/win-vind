        ...
        : wxDialog(NULL, wxID_ANY, title)
{
    ...
    // (and 64 on Win9x)
    if ( !m_taskBarIcon->SetIcon(wxIcon("resources/icon32.ico", wxBITMAP_TYPE_ICO), "win-vind")) {
...
{
    //Change Icon
    if (!SetIcon(wxIcon("resources/icon32.ico", wxBITMAP_TYPE_ICO), wxT("wxTaskBarIcon Sample - a different icon")))
