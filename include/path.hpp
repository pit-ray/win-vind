...
namespace Path
{
    static constexpr auto _USE_INSTALLER = true ;
    ...
    static inline const auto _get_home_path() noexcept {
        ...
        if(!GetEnvironmentVariable("HOMEPATH", home_path, 1000)) {
    ...
    inline static const auto& CONFIG_INI() noexcept {
        static const auto obj = _get_path("default.ini") ;
        return obj ;
    }

    inline static const auto& CONFIG_OPTION_INI() noexcept {
        static const auto obj = _get_path("option.ini") ;
        return obj ;
    }

    inline static const auto& CONFIG_XML() noexcept {
        static const auto obj = _get_path("default.xml") ;
        return obj ;
    }
