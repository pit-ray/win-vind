...
TEST_SUITE("util/box_2d") {
    ...
    TEST_CASE("operator value-based comparison") {
        Box2D b0(0, 20, 30, 40) ;
    ...
    TEST_CASE("size-based comparison is_same()") {
    ...
    TEST_CASE("size-based comparison is_not_same()") {
    ...
    TEST_CASE("size-based comparison") {
        Box2D b1(Point2D(20, 40), 400, 500) ;
