...
TEST_CASE("(util::util::width, util::util::height) I/O") {
...
TEST_CASE("(util::util::center_x, util::util::center_y) I/O") {
...
TEST_CASE("(util::util::l1_distance) L1 I/O") {
    LONG dx = 12, dy = 34 ;
    LONG hw = 234, hh = 514 ;
...
TEST_CASE("(util::util::l2_distance, util::util::l2_distance_nosq) L2 I/O") {
    LONG dx = 3, dy = 4 ;
    LONG hw = 232, hh = 518 ;
...
TEST_CASE("(util::util::is_ouf_of_range) check out of") {
    RECT r1{20, 60, 300, 600} ;
    RECT r2{302, 50, 502, 700} ;
    CHECK(util::is_out_of_range(r1, r2)) ;
}

TEST_CASE("(util::util::is_fully_in_range) check in") {
