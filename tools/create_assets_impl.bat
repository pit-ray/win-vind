...
mkdir ".\\bin_%3\\win-vind\\default_config"
mkdir ".\\bin_%3\\win-vind\\resources"

copy /Y ".\\release_%3\\win-vind.exe" ".\\bin_%3\\win-vind\\win-vind.exe"
xcopy /e /Y ".\\res\\default_config" ".\\bin_%3\\win-vind\\default_config"
xcopy /e /Y ".\\res\\resources" ".\\bin_%3\\win-vind\\resources"
