...
|:---:|:---:|
|`I`, `<esc-right>`, `<ctrl-[>`|[\<to_edi_normal\>]({{ site.url }}/cheat_sheet/functions/#to_edi_normal)|
...
|`<Right>`, `<Space>`, `l`|[\<move_caret_right\>]({{ site.url }}/cheat_sheet/functions/#move_caret_right)|
|`<Up>`, `k`, `<C-p>`, `-`, `gk`|[\<move_caret_up\>]({{ site.url }}/cheat_sheet/functions/#move_caret_up)|
|`<C-n>`, `gj`, `<C-m>`, `<Enter>`, `+`, `j`, `<Down>`|[\<move_caret_down\>]({{ site.url }}/cheat_sheet/functions/#move_caret_down)|
