...
namespace
{
    ...
    const std::vector<std::pair<std::string, std::string>>& command() {
        static std::vector<std::pair<std::string, std::string>> tmp = {
            ...
            {"map<space><any>", "<map>"},
            {"noremap<space><any>", "<noremap>"},
            {"unmap<space><any>", "<unmap>"},
            {"mapclear<space><any>", "<mapclear>"},
            {"gmap<space><any>", "<gmap>"},
            {"gnoremap<space><any>", "<gnoremap>"},
            {"gunmap<space><any>", "<gunmap>"},
            {"gmapclear<space><any>", "<gmapclear>"},
            {"emap<space><any>", "<emap>"},
            {"enoremap<space><any>", "<enoremap>"},
            {"eunmap<space><any>", "<eunmap>"},
            {"emapclear<space><any>", "<emapclear>"},
            {"nmap<space><any>", "<nmap>"},
            {"nnoremap<space><any>", "<nnoremap>"},
            {"nunmap<space><any>", "<nunmap>"},
            {"nmapclear<space><any>", "<nmapclear>"},
            {"vmap<space><any>", "<vmap>"},
            {"vnoremap<space><any>", "<vnoremap>"},
            {"vunmap<space><any>", "<vunmap>"},
            {"vmapclear<space><any>", "<vmapclear>"},
            {"gnmap<space><any>", "<gnmap>"},
            {"gnnoremap<space><any>", "<gnnoremap>"},
            {"gnunmap<space><any>", "<gnunmap>"},
            {"gnmapclear<space><any>", "<gnmapclear>"},
            {"gvmap<space><any>", "<gvmap>"},
            {"gvnoremap<space><any>", "<gvnoremap>"},
            {"gvunmap<space><any>", "<gvunmap>"},
            {"gvmapclear<space><any>", "<gvmapclear>"},
            {"enmap<space><any>", "<enmap>"},
            {"ennoremap<space><any>", "<ennoremap>"},
            {"enunmap<space><any>", "<enunmap>"},
            {"enmapclear<space><any>", "<enmapclear>"},
            {"evmap<space><any>", "<evmap>"},
            {"evnoremap<space><any>", "<evnoremap>"},
            {"evunmap<space><any>", "<evunmap>"},
            {"evmapclear<space><any>", "<evmapclear>"},
            {"imap<space><any>", "<imap>"},
            {"inoremap<space><any>", "<inoremap>"},
            {"iunmap<space><any>", "<iunmap>"},
            {"imapclear<space><any>", "<imapclear>"},
            {"rmap<space><any>", "<rmap>"},
            {"rnoremap<space><any>", "<rnoremap>"},
            {"runmap<space><any>", "<runmap>"},
            {"rmapclear<space><any>", "<rmapclear>"},
            {"cmap<space><any>", "<cmap>"},
            {"cnoremap<space><any>", "<cnoremap>"},
            {"cunmap<space><any>", "<cunmap>"},
            {"cmapclear<space><any>", "<cmapclear>"},
            ...
            {"command<space>", "<command>"},
            {"com<space><any>",  "<command>"},
            {"command<space><any>",  "<command>"},
            {"command<space><any>",  "<command>"},
            {"delc", "<delcommand>"},
            {"delcommand", "<delcommand>"},
            {"delc<space>",  "<delcommand>"},
            {"delcommand<space>", "<delcommand>"},
            {"delc<space><any>", "<delcommand>"},
            {"delcommand<space><any>", "<delcommand>"},
            {"comc", "<comclear>"},
            {"comclear", "<comclear>"},
            {"comc<space>",  "<comclear>"},
            {"comclear<space>",  "<comclear>"},
            {"comc<space><any>", "<comclear>"},
            {"comclear<space><any>", "<comclear>"},
            {"so", "<source>"},
            {"source", "<source>"},
            {"so<space>", "<source>"},
            {"source<space>", "<source>"},
            {"so<space><any>", "<source>"},
            {"source<space><any>", "<source>"},
        } ;
        return tmp ;
    }
}
