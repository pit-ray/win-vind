...
namespace UITrans
{
    ...
    const wxString& trans(const std::string id) {
        ...
        static const std::unordered_map<std::string, wxString> id2jp {
            ...
            //Editor
            {"change_to_edi_normal",         wxT("エディタノーマルモード")},
            {"change_to_edi_insert",         wxT("エディタインサートモード")},
            {"change_to_edi_bkinsert",       wxT("エディタバックインサートモード")},
            {"change_to_edi_nlinsert",       wxT("エディタ改行インサートモード")},
            {"change_to_edi_visual",         wxT("エディタヴィジュアルモード")},
            {"edi_move_left",                wxT("左へキャレット移動")},
            {"edi_move_right",               wxT("右へキャレット移動")},
            {"edi_move_up",                  wxT("上へキャレット移動")},
            {"edi_move_down",                wxT("下へキャレット移動")},
        ...
        static const std::unordered_map<std::string, wxString> id2us {
            ...
            //Editor
            {"change_to_edi_normal",         "Change to Editor Normal"},
            {"change_to_edi_insert",         "Change to Editor Insert"},
            {"change_to_edi_bkinsert",       "Change to Editor BackInsert"},
            {"change_to_edi_nlinsert",       "Change to Editor NewLineInsert"},
            {"change_to_edi_visual",         "Change to Editor Visual"},
            {"edi_move_left",                "Editor Move Left"},
            {"edi_move_right",               "Editor Move Right"},
            {"edi_move_up",                  "Editor Move Up"},
            {"edi_move_down",                "Editor Move Down"},
            ...
            {"move_acceleration",       "Move Cursor Acceleration"},
